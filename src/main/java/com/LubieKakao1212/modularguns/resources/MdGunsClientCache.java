...
import com.LubieKakao1212.modularguns.item.render.GunModel;
...
public class MdGunsClientCache {

    private static Map<ResourceLocation, GunModel> modelCache = new HashMap<>();
    public static final GunModel defaultModel;
    public static final ResourceLocation defaultModelId = new ResourceLocation("mdguns:potato");
